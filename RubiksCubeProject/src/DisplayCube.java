...
//        g.fillPolygon(makeUpFaceSticker(1, 0));
//        g.fillPolygon(makeUpFaceSticker(2, 0));
//        g.fillPolygon(makeUpFaceSticker(0, 1));
//        g.fillPolygon(makeUpFaceSticker(1, 1));
//        g.fillPolygon(makeUpFaceSticker(2, 1));
//        g.fillPolygon(makeUpFaceSticker(0, 2));
//        g.fillPolygon(makeUpFaceSticker(1, 2));
//        g.fillPolygon(makeUpFaceSticker(2, 2));
////        g.setColor(Color.BLACK);
////        g.fillPolygon(rhombus1);
//        g.setColor(Color.CYAN);
//        g.fillPolygon(makeFrontFaceSticker(0, 0));
//        g.fillPolygon(makeFrontFaceSticker(1, 0));
//        g.fillPolygon(makeFrontFaceSticker(2, 0));
//        g.fillPolygon(makeFrontFaceSticker(0, 1));
//        g.fillPolygon(makeFrontFaceSticker(1, 1));
//        g.fillPolygon(makeFrontFaceSticker(2, 1));
//        g.fillPolygon(makeFrontFaceSticker(0, 2));
//        g.fillPolygon(makeFrontFaceSticker(1, 2));
//        g.fillPolygon(makeFrontFaceSticker(2, 2));
//
//
//        g.setColor(Color.PINK);
//        g.fillPolygon(makeRightFaceSticker(0, 0));
//        g.fillPolygon(makeRightFaceSticker(1, 0));
//        g.fillPolygon(makeRightFaceSticker(2, 0));
//        g.fillPolygon(makeRightFaceSticker(0, 1));
//        g.fillPolygon(makeRightFaceSticker(1, 1));
//        g.fillPolygon(makeRightFaceSticker(2, 1));
//        g.fillPolygon(makeRightFaceSticker(0, 2));
//        g.fillPolygon(makeRightFaceSticker(1, 2));
//        g.fillPolygon(makeRightFaceSticker(2, 2));

//        g.setColor(Color.WHITE);
//        g.drawPolygon(makeUpFaceSticker(0, 2));
//        g.drawPolygon(makeUpFaceSticker(1, 1));
//        g.drawPolygon(makeUpFaceSticker(1, 3));
//        g.drawPolygon(makeUpFaceSticker(2, 0));
//        g.drawPolygon(makeUpFaceSticker(2, 2));
//        g.drawPolygon(makeUpFaceSticker(2, 4));
//        g.drawPolygon(makeUpFaceSticker(3, 1));
//        g.drawPolygon(makeUpFaceSticker(3, 3));
//        g.drawPolygon(makeUpFaceSticker(4, 2));
////        g.setColor(Color.BLACK);
////        g.fillPolygon(rhombus1);
//        g.setColor(Color.CYAN);
//        g.drawPolygon(makeFrontFaceSticker(0, 0));
//        g.drawPolygon(makeFrontFaceSticker(0, 1));
//        g.drawPolygon(makeFrontFaceSticker(0, 2));
//        g.drawPolygon(makeFrontFaceSticker(1, 0));
//        g.drawPolygon(makeFrontFaceSticker(1, 1));
//        g.drawPolygon(makeFrontFaceSticker(1, 2));
//        g.drawPolygon(makeFrontFaceSticker(2, 0));
//        g.drawPolygon(makeFrontFaceSticker(2, 1));
//        g.drawPolygon(makeFrontFaceSticker(2, 2));
//
//
//        g.setColor(Color.PINK);
//        g.drawPolygon(makeRightFaceSticker(0, 0));
//        g.drawPolygon(makeRightFaceSticker(0, 1));
//        g.drawPolygon(makeRightFaceSticker(0, 2));
//        g.drawPolygon(makeRightFaceSticker(1, 0));
//        g.drawPolygon(makeRightFaceSticker(1, 1));
//        g.drawPolygon(makeRightFaceSticker(1, 2));
